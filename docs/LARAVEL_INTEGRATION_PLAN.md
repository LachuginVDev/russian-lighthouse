...
2. Filament Resources + Settings singleton.  
3. Seed из текущего демо-контента вёрстки.  
4. Загрузка медиа (обложки, аудио, фото).  
5. Страницы `privacy`, `reports`.  

**Критерий:** контент главной и разделов редактируется из `/admin`.
