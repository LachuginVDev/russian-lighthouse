...
class DemoContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $news = News::query()->updateOrCreate(
            ...
            [
                'title' => 'Концерт в госпитале Ростова',
                'excerpt' => 'Выступили перед бойцами, передали письма и собрали истории для новых песен.',
                'category' => NewsCategory::Trips,
                'body' => '<h2 id="vstrecha">Встреча</h2><p>Мы приехали утром и провели день в палатах и актовом зале.</p><h2 id="posle">После концерта</h2><p>Бойцы делились историями — из них рождаются новые песни.</p>',
                'author_name' => 'Редакция',
                'author_role' => 'Пресс-служба',
                'author_initials' => 'РМ',
                'reading_time' => '4 мин',
                'embedded_track_id' => Track::query()->where('title', 'Свет')->value('id'),
                'is_featured_home' => true,
                'published_at' => now()->subDays(5),
                'sort_order' => 1,
                'meta_title' => 'Концерт в госпитале Ростова — новости',
            ],
        );
